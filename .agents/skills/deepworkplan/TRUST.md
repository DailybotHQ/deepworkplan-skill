...
# 5. No unpinned clone-and-run installs (installing by cloning whatever a
#    remote default branch currently holds, then executing its scripts):
grep -RInE --exclude=TRUST.md 'git clone .*\.git' skills/deepworkplan \
