...
- **Guide (essential — read for this flow):** [`../guide/authoring.md`](../guide/authoring.md) (plan README structure §4, task-file anatomy §5, test and security discipline §5.3–§5.4) and [`../guide/structure.md`](../guide/structure.md) (folders §1, naming §2, lifecycle §10).
- **Guide (conditional — read only when the trigger fires):** [`../guide/orchestrator.md`](../guide/orchestrator.md) if Step 2.6 detects an orchestrator plan; [`../guide/team-agents.md`](../guide/team-agents.md) if Step 2.10 detects parallelizable tasks; [`../guide/prompts.md`](../guide/prompts.md) §7 when composing prompt text; [`../guide/skills-integration.md`](../guide/skills-integration.md) §11 when a task references skills or agents; [`../guide/execution.md`](../guide/execution.md) §6.1 when writing the Final Review task. Do not read other guide files for this flow; [`../guide/GUIDE.md`](../guide/GUIDE.md) is the routing index, consulted only when a section is not named above.
...
Follow `../guide/authoring.md` (§4–§5) and `../guide/structure.md` (§1–§2). Create:
...
6. **User-defined task files** — `N.task_{title}.md`, each with Context, Read
   ...
   it (`../guide/authoring.md` §5.3): its Acceptance Criteria **must** require
   ...
   **must** run the repo's tests plus lint/type-check/format checks (not the
   ...
   (`../guide/authoring.md` §5.4); where the security-sensitive work is substantial,
